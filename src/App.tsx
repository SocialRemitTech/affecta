      ...
      <main className="site-shell">
        ...
        <nav className="topbar" aria-label="Main navigation">
          <a
            className="brand"
            href="#top"
            aria-label="Affecta Technologies home"
          >
        ...
        <section
          className="manifesto"
          aria-label="Affecta's mission and vision"
        >
          <div className="manifesto-heading">
            <h2>
              Built from lived
              <br />
              <span>experience,</span> not theory.
            </h2>
          </div>
          <div className="manifesto-body">
            <div className="statement">
              ...
              <p>
                Building the first Emotional Finance Infrastructure™ for the
                Global South — designed from lived experience, not theory.
              </p>
            </div>
            <div className="statement">
              <span className="statement-label">Our vision</span>
              <p>
                To give 4.5 billion underserved people the tools, intelligence,
                and infrastructure to participate <strong>fairly</strong> and
